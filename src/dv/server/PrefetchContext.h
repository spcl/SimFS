...
namespace dv {
    ...
    public:
        ...
        void handleHit(dv::id_type target_nr, std::string parameters);
        void handleMiss(dv::id_type target_nr, std::string parameters); 
    ...
    private:
        ...
        void check_for_prefetch(dv::id_type target_nr); 
