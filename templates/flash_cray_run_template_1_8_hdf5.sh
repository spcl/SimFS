...
#real
srun -u -n 8 -N 1 --ntasks-per-node 8 -C mc $$SIMULATOR_DIR/flash4 -par_file $__PARFILE__ >$$SDAVI_DIR/logs/flash.$${DVL_JOBID}.out 2>$$SDAVI_DIR/logs/flash.$${DVL_JOBID}.err &
