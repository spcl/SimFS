...
#real
srun -u -n 27 -N 1 --ntasks-per-node 27 -C mc $$SIMULATOR_DIR/flash4 -par_file $__PARFILE__ >$$SDAVI_DIR/logs/flash.$${DVL_JOBID}.out 2>$$SDAVI_DIR/logs/flash.$${DVL_JOBID}.err &
