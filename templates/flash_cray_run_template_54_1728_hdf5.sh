...
#real
srun -u -n 1728 -N 54 --ntasks-per-node 32 -C mc $$SIMULATOR_DIR/flash4 -par_file $__PARFILE__ >$$SDAVI_DIR/logs/flash.$${DVL_JOBID}.out 2>$$SDAVI_DIR/logs/flash.$${DVL_JOBID}.err &
